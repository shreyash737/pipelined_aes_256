module sub_bytes(input [127:0] in [15:0] , output [127:0] out [15:0]);
    
    
    s_box instance1(s[0], out[0]);
    s_box instance2(s[1], out[1]);
    s_box instance3(s[2], out[2]);
    s_box instance4(s[3], out[3]);

    s_box instance5(s[4], out[4]);
    s_box instance6(s[5], out[5]);
    s_box instance7(s[6], out[6]);
    s_box instance8(s[7], out[7]);

    s_box instance9(s[8], out[8]);
    s_box instance10(s[9], out[9]);
    s_box instance11(s[10], out[10]);
    s_box instance12(s[11], out[11]);

    s_box instance13(s[12], out[12]);
    s_box instance14(s[13], out[13]);
    s_box instance15(s[14], out[14]);
    s_box instance16(s[15], out[15]);
